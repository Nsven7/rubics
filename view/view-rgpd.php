...
<body>
    <div class="container-content">
        <div class="container-centre blur">
            <h1>Quelles données sont collectées ?</h1>
            <p>Nous collectons uniquement les données nécessaires à la réalisation de cette étude, à savoir :</p>
            <ul>
                <li>Pays d'origine des demandes</li>
            </ul>

            <h2>Pourquoi collectons-nous ces données ?</h2>
            <p>Les données sont collectées dans le but de :</p>
            <ul>
                <li>Identifier les pays qui utilisent le plus nos services</li>
                <li>Améliorer et adapter nos services en fonction de la demande géographique</li>
            </ul>

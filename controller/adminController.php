...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    switch ($action) {
        case 'Enregistrer':
            ...
            $actif = intval($_POST['actif'] == 1 ? 1 : 0);
            $roleActif = intval($_POST['roleActif'] == 1 ? 1 : 0);
            ...
            if (isset($fileToUpload)) {
                ...
                $path = "/Rubics/public/uploads/employees/" . $newName . "/";
                $avatar = $path . $newName . $extension;

                $fileToUploaded = uploadFile($path, $newName);
            } else {
                if (isset($employee)) {
